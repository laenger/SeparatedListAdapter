...
public class DemoAdapter2 extends ArrayAdapter<String> {

    private final List<String> objects;
    private final LayoutInflater inflater;

    public DemoAdapter2(Context context, List<String> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_adapter2, parent, false);
